...
describe("parseRelayAllowedOrigins", () => {
  ...
  it("accepts and deduplicates HTTPS and loopback HTTP origins", () => {
    expect(parseRelayAllowedOrigins(
      "http://127.0.0.1:4177, https://workbench.example.com/, http://127.0.0.1:4177",
    )).toEqual(["http://127.0.0.1:4177", "https://workbench.example.com"]);
  });

  it.each([
    "http://example.com",
    "http://user:secret@127.0.0.1:4177",
    "http://127.0.0.1:4177/workbench",
